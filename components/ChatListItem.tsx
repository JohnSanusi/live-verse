...
import { Users, Archive, FolderArchive } from "lucide-react";
...
export const ChatListItem = ({
  ...
  return (
    <Card
      ...
      className="mb-2 border-none bg-transparent hover:bg-secondary/30 transition-colors p-3 active-scale group/item cursor-pointer"
    >
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-1 min-w-0">
              ...
              {!isGroup && user.isVerified && <EliteBadge size={14} />}
              {isGroup && (
        ...
        {onArchive && (
          ...
          >
            {isArchived ? <FolderArchive size={16} /> : <Archive size={16} />}
          </button>
        )}
      </div>
    </Card>
