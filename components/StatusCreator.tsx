  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-background border-t sm:border border-border rounded-t-[2.5rem] sm:rounded-[2.5rem] w-full max-w-xl p-6 sm:p-8 shadow-2xl overflow-hidden relative"
      >
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <div className="h-12 w-12 rounded-2xl bg-secondary flex items-center justify-center text-primary font-black border border-border overflow-hidden">
            ...
            <div>
              <h2 className="text-lg font-black tracking-tight">New Status</h2>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-border/50">
            <div className="flex items-center gap-2">
              ...
              <Button
                variant="secondary"
                size="sm"
                className="h-12 w-12 rounded-2xl p-0 flex items-center justify-center bg-secondary hover:bg-primary/10 hover:text-primary transition-all active-scale"
                onClick={() =>
            ...
            <Button
              className="px-8 h-12 rounded-2xl font-black uppercase tracking-widest text-[10px] bg-primary text-primary-foreground shadow-lg shadow-primary/20 active-scale disabled:opacity-20 transition-all font-bold"
