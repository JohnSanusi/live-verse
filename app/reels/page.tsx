...
const MOCK_REELS = [
  {
    id: 1,
    user: { name: "Alex Johnson", avatar: "A", handle: "@alex_j" },
  ...
  {
    id: 2,
    user: { name: "Sarah Williams", avatar: "S", handle: "@sarah_w" },
  ...
  {
    id: 3,
    user: { name: "Mike Chen", avatar: "M", handle: "@mike_c" },
    ...
    <>
      ...
      {MOCK_REELS.map((reel, index) => (
        ...
        >
          ...
          {/* Content Overlay */}
          <div className="absolute bottom-0 left-0 right-0 p-4 pb-20 md:pb-4 z-10">
