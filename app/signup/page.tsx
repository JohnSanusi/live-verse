...
export default function SignupPage() {
  ...
  const { signup, signInWithGoogle, signInWithApple } = useApp();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (await signup(name, email, password)) {
      ...
      setError(
        "This identity index is already registered or verification failed."
      );
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-6 relative overflow-hidden font-outfit">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[45%] h-[45%] bg-primary/20 rounded-full blur-[130px] animate-pulse-slow"></div>
      <div
        className="absolute bottom-[-10%] left-[-10%] w-[45%] h-[45%] bg-indigo-500/20 rounded-full blur-[130px] animate-pulse-slow font-bold"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  className="h-14 bg-white/[0.05] border-white/10 rounded-2xl focus:ring-primary/50 text-white placeholder:text-muted-foreground/30 pl-14 pr-5"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  className="h-14 bg-white/[0.05] border-white/10 rounded-2xl focus:ring-primary/50 text-white placeholder:text-muted-foreground/30 pl-14 pr-12"
                  required
                  minLength={6}
                />
                <button
